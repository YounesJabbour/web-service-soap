 ...
 * 
 */
@WebServiceClient(name = "BankServiceService", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:9090/?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANKSERVICESERVICE_QNAME = new QName("http://ws/", "BankServiceService");
